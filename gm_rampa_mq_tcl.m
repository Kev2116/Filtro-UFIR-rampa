...
function tclCmds = gm_rampa_mq_tcl
tclCmds = {
    'do rampa_compile.do',...% Compile the generated code
    'vsimulink   work.rampa',...% Initiate cosimulation
    'add wave  /rampa/clk',...% Add wave commands for chip input signals
    'add wave  /rampa/in1',...
    'add wave  /rampa/out_rsvd',...% Add wave commands for chip output signals
